module.exports = function (less) {
    ...
    AutoRTLPlugin.prototype = {
        ...
        visitDeclaration: function (ruleNode, visitArgs) {
            console.log(ruleNode.value.value[0].value && ruleNode.value.value[0].value[0].type);
        ...
        visitRuleset: function (rulesetNode, visitArgs) {
            ...
            switch (this._generalDirection) {
                case 'ltr':
                    return this.createRuleset(rulesetNode, [...ltrRules, ...nonRtlRules], rtlRules, rulesets, parentDirection);
                case 'rtl':
                    return this.createRuleset(rulesetNode, ltrRules, [...rtlRules, ...nonRtlRules], rulesets, parentDirection);
                case 'both':
                case 'auto':
                default:
                    return this.createRuleset(rulesetNode, ltrRules, rtlRules, [...nonRtlRules, ...rulesets], parentDirection);
